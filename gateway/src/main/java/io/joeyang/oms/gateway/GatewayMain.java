 ...
 *
 * <p>This process will host the {@code AeronCluster} client and the protocol adapters (FIX, SBE).
 * It reaches the state machine only by submitting ordered ingress to the cluster, never by
